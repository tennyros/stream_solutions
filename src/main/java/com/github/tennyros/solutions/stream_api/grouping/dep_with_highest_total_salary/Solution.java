...
/**
 * Определить департамент с наибольшей суммарной зарплатой
 * <br><br>
 * Нужно вернуть название департамента, в котором суммарная зарплата всех сотрудников максимальна
 * <br><br>
 * 📥 Вход:
 * <br>
 * Список объектов Employee с полями:
 * <br>
 * - name (String)
 * <br>
 * - department (String)
