...
/**
 * Сотрудники, чья зарплата выше медианной по их отделу
 * <br><br>
 * Условие:
 * <br>
 * Для каждого департамента определить список сотрудников, чьи зарплаты строго выше медианной зарплаты по их отделу.
 * <br><br>
 * Сигнатура метода:
 * <br>
 * public static Map<String, List<String>> aboveMedianSalaryByDepartment(List<Employee> employees)
 * <br><br>
 * Пример: Если в департаменте "IT" зарплаты: 8000, 10000, 12000 — медиана будет 10000. В результат попадут только те, у кого зарплата > 10000.
 */
