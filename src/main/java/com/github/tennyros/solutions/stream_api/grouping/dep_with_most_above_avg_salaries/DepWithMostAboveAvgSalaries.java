 ...
 * количество сотрудников получает зарплату выше средней по всей компании. <br><br>
 * Условия: <br>
 * У нас есть список сотрудников, каждый из которых имеет: <br>
 * - name (имя сотрудника), <br>
 * - department (департамент), <br>
 * - salary (зарплата сотрудника). <br>
 * Необходимо вычислить среднюю зарплату по всем сотрудникам. <br>
 * Нужно найти департамент, в котором наибольшее количество
 * сотрудников получает зарплату выше средней. <br>
 * Если в нескольких департаментах одинаковое количество сотрудников
 * с зарплатой выше средней, выберите любой департамент. <br>
