...
/**
 * <b>Самые опытные сотрудники в каждом департаменте</b> <br></br>
 * Нужно реализовать метод: <br>
 * public static Map<String, List<String>> topExperiencedEmployeesByDepartment(List<Employee> employees, int topN) <br>
 * 🔹 Метод должен вернуть Map<департамент, список имён сотрудников>,
 * где список содержит top N самых опытных сотрудников из каждого департамента. <br>
 * 🔹 Если в департаменте меньше N человек — вернуть всех. <br>
