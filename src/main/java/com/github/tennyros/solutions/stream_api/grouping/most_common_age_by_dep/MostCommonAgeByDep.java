...
/**
 * Самый популярный возраст в каждом отделе <br><br>
 * У тебя есть список сотрудников (List<Employee>), и тебе нужно определить: <br><br>
 * Какой возраст встречается чаще всего в каждом отделе. <br><br>
