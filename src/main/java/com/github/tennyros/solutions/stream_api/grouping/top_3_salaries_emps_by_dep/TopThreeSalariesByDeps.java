...
/**
 * Список сотрудников, у которых зарплата входит в топ-3 в каждом департаменте
 * <br><br>
 * Условие:
 * <br>
 * У тебя есть список List<Employee> employees, у каждого Employee есть:
 * <br>
 * - имя (getName()),
 * <br>
 ...
 * Нужно:
 * <br>
 * Вернуть Map<String, List<String>>, где:
 * <br>
 * - ключ — это название департамента,
 * <br>
 * - значение — список имён сотрудников с топ-3 зарплатами в этом департаменте.
 * <br><br>
 * Пример:
 * <br>
